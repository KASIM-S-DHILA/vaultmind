  ...
  return (
    <div style={{ textAlign: 'center', padding: '20px 0' }}>
      ...
      <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 24, maxWidth: 400, margin: '0 auto 24px' }}>
        Your private AI assistant is set up and ready. Upload your documents and ask questions —
        every answer is grounded in your sources. Everything runs locally, no data leaves your device.
      </p>
